...
module.exports = {
  ...
  db: process.env.MONGODB || process.env.MONGOLAB_URI || 'mongodb://52.77.242.147:27017/test',
  ...
  sendgrid: {
    user: process.env.SENDGRID_USER || 'k1e13',
    password: process.env.SENDGRID_PASSWORD || 'Welcome1'
  },
